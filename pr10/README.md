...
![Task 1 Execution](pr10_scr/task1.jpg)
...
*Практичне застосування:* Цей підхід є критично важливим при розробці високонавантажених або системних програм (серверів, демонів) для автоматичного збору crash-дампів та логування точних причин падіння перед завершенням процесу, що значно пришвидшує подальший дебагінг.
...
![Task 2 Execution](pr10_scr/task2.jpg)
...
*Практичне застосування:* Такі таймери необхідні для написання систем реального часу та програм, що потребують суворої періодичності виконання незалежно від зовнішніх переривань, наприклад, для регулярного опитування IoT-датчиків (температури, освітленості), збору системних метрик або керування автоматикою.
...
![Task 3 Execution](pr10_scr/task3.jpg)
...
*Практичне застосування:* Цей метод відмінно підходить для організації легковагового асинхронного зв'язку (IPC) між процесами. Наприклад, для передачі коротких статусних кодів чи ідентифікаторів подій від робочих (worker) процесів до головного (master) процесу без необхідності розгортати складні черги повідомлень чи сокети.
...
![Task 4 Execution](pr10_scr/task4.jpg)
