...
**Пояснення:**
Згідно зі стандартом, `malloc(0)` може повернути `NULL` або унікальний вказівник. У `glibc` зазвичай повертається валідний (ненульовий) вказівник. Його не можна розіменовувати для запису чи читання даних, але його можна ( безпечно передати у `free()`. Аналіз через `ltrace` підтверджує, що функція викликається, повертає адресу, і пам'ять успішно звільняється без помилок.
...
![Аналіз maps - 2](pr4_scr/task8_13_x.jpg)
![Аналіз maps - 3](pr4_scr/task8_13_2.jpg)
![Аналіз maps - 4](pr4_scr/task8_13_3.jpg)
![Аналіз maps - 5](pr4_scr/task8_13_4.jpg)
![Аналіз maps - 6](pr4_scr/task8_13_5.jpg)
![Аналіз maps - 7](pr4_scr/task8_13_6.jpg)
![Аналіз maps - 8](pr4_scr/task8_13_7.jpg)
